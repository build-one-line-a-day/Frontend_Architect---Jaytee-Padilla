...
import journal from '../assets/notebook-and-pencil.svg';
...
export default function JournalEntries (props) {
	...
	useEffect(() => {
		axiosWithAuth()
			.get(`https://one-line-daily.herokuapp.com/api/entries/user/${loginId}`)
			.then((response) => {
	...
	return (
		<React.Fragment>
			...
			<Image
				...
				src={journal}
				alt="journal"
				style={{ width: '300px', maxHeight: '30vh', marginBottom: '20px' }}
			/>
